...
export const MOCK_LOANS = [
  { id: 'L1', borrower: 'CryptoNomad', asset: 'USDT', amount: 5000, collateral: 'BTC', collateralAmount: 0.21, apy: 12.5, duration: 30, ltv: 65, status: 'active', dueIn: 245, date: 'Oct 24, 2024' },
  { id: 'L2', borrower: 'DefiWhale', asset: 'USDC', amount: 3200, collateral: 'ETH', collateralAmount: 2.5, apy: 8.4, duration: 90, ltv: 42, status: 'active', dueIn: 12, date: 'Oct 12, 2024' },
];
